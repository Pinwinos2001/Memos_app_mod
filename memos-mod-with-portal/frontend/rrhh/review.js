...
async function load(){
  ...
  if(d.legal_aprobado !== 'APROBADO'){
    memoDiv.innerHTML = '<b>Este memo debe ser aprobado por Legal primero.</b>';
...
form.addEventListener('submit', async (e)=>{
  ...
  const d = await r.json();
  if(d && d.ok){ alert('Guardado: '+d.status); location.href = d.dashboard || '/dashboard/index.html'; }
